"""
Train LightGBM model for 180-Day GitHub Star Forecasting (STATIONARY TARGET)
Predicts PERCENTAGE GROWTH instead of absolute values to remove trend
Target: (stars_180d_ahead - current_stars) / current_stars
This makes the target scale-invariant and stationary
"""
...
# === Configuration ===
SOURCE_PATH = 'github_features_lead_stationary.parquet'
TRAIN_PATH = 'train_dataset_lead180d_stationary.parquet'
...
print("Target: growth_rate = (stars_180d_ahead - current_stars) / current_stars")
...
# 1. Lead value is null (last 180 days)
