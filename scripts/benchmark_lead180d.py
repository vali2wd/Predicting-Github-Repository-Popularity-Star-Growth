"""
Benchmark 180-Day Lead Forecasting Model
Direct forecast: Predict stars 180 days ahead using only current/past data
...
def run_benchmark():
    ...
    for idx, repo_name in enumerate(repo_names):
        ...
        # Remove rows with null targets (last 180 days won't have lead values)
        ...
        # Plot predicted stars 180 days ahead
    ...
    print(f"   based on current activity, lags (including 60-day), and rolling statistics.")
