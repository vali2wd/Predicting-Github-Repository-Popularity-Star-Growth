"""
Train LightGBM model for 30-Day GitHub Star Forecasting
Direct forecasting approach: Predict stars 30 days ahead using current activity
...
TRAIN_PATH = 'train_dataset_lead30d.parquet'
VAL_PATH = 'val_dataset_lead30d.parquet'
MODEL_PATH = 'lgbm_github_lead30d.pkl'
FORECAST_HORIZON = 30  # Predicting 30 days ahead
...
# Drop rows with null targets (last 30 days of data won't have lead values)
...
# Actual stars 30 days ahead
actual_future = y_val

# Predicted stars 30 days ahead
