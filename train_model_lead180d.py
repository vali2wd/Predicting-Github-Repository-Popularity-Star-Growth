"""
Train LightGBM model for 180-Day GitHub Star Forecasting
Direct forecasting approach: Predict stars 180 days ahead using current activity
...
TRAIN_PATH = 'train_dataset_lead180d.parquet'
VAL_PATH = 'val_dataset_lead180d.parquet'
MODEL_PATH = 'lgbm_github_lead180d.pkl'
FORECAST_HORIZON = 180  # Predicting 180 days ahead
...
# Drop rows with null targets (last 180 days of data won't have lead values)
...
print(f"  - Lags (1d, 7d, 30d, 60d): {len([c for c in feature_cols if 'lag' in c])}")
...
# Actual stars 180 days ahead
actual_future = y_val

# Predicted stars 180 days ahead
